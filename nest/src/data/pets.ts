// 宠物类型定义（与教师端 admin/src/data/pets.ts 保持一致）
...
export function isMythicalPet(petId: string): boolean {
  return getPetType(petId)?.category === 'mythical'
}
